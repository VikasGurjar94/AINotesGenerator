...
function Navbar() {
  ...
  cursor-pointer"
          >
            <span className="text-xl text-center items-center ">💎</span>
            <span>{credits}</span>
      ...
      rounded-full bg-white text-black text-center text-xs font-bold"
            >
              <IoMdAdd size={30} />
            </motion.span>
          </motion.div>
          <AnimatePresence>
            {showCredits && (
              <motion.div
                ...
                className="absolute -right-2.5 mt-4 w-64
  rounded-2xl
  ...
  cursor-pointer"
          >
            <span className="text-lg text-center flex justify-center items-center ">
