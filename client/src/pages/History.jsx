...
function History() {
  ...
  return (
    ...
    rounded-lg text-sm text-gray-200 bg-white/10 text-start hover:bg-white/20"
                >
                  ➕ New Notes
                </button>
              </div>
              ...
              <h2
                className="mb-4 text-lg font-bold bg-gradient-to-r from-white
...
`}
                  >
                    ...
                    <div className="flex flex-wrap gap-2 mt-2 text-xs">
                      {t.classLevel && (
                        <span
                          className="px-2 py-0.5 rounded-full bg-indigo-500/20 
                                   text-indigo-300"
                        >
    ...
    min-h-[75vh]"
        >
          ...
          {!loading && selectedNote && <FinalNotes result={selectedNote} />}
        </motion.div>
      </div>
    </div>
  );
